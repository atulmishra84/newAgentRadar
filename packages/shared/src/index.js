...
const CONNECTOR_PROVIDERS = [
  ...
  { id: 'm365', name: 'Microsoft 365 Copilot', group: 'saas', fields: ['tenantId', 'clientId', 'clientSecret'], firstWave: true, liveCapable: false },
  ...
  { id: 'epic', name: 'Epic EHR', group: 'healthcare', fields: ['fhirBaseUrl', 'clientId', 'clientSecret'], hipaa: true, firstWave: true, liveCapable: false },
  ...
  { id: 'crowdstrike', name: 'CrowdStrike Falcon', group: 'edr', fields: ['clientId', 'clientSecret', 'baseUrl'], firstWave: true, liveCapable: false },
  { id: 'defender', name: 'Microsoft Defender for Endpoint', group: 'edr', fields: ['tenantId', 'clientId', 'clientSecret'], firstWave: true, liveCapable: false },
  { id: 'intune', name: 'Microsoft Intune', group: 'edr', fields: ['tenantId', 'clientId', 'clientSecret'], firstWave: true, liveCapable: false },
